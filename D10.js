...
let dice = function getRandomInt(min, max) {
...
const isThisAnEmail = (email) => {
  return (
    (email.includes("@") && email.includes(".it")) || email.includes(".com")
  )
}
...
console.log(howManyDays(new Date(2021, 11, 16)))
...
// const isTodayMyBirthday = (mybirt) => {
//   let oggi = new Date().toISOString()
//   let mese = String(oggi.getMonth())
//   let giorno = String(oggi.getDate())
//   let data = mybirt.split("/")
//   let [giornoComplex, meseComplex] = data
//   if (mese === meseComplex && giorno === giornoComplex) {
//     console.log("E' IL TUO COMPLEAANO")
//   }
// }
// console.log(isTodayMyBirthday("2/11/2022"))
...
const newMovie = (array) => {
  let result = { Year: 2019 }
...
/* ESERCIZIO 17
  Scrivi una funzione chiamata "searchByTitle" che riceve una stringa come parametro e ritorna i film dell'array "movies" fornito che la contengono nel titolo.
  */
